Temisis is a free and open-source DAW for desktop platforms:
...
Please delete any old Helio installs as Temisis might install brand new plugins into your Helio Workstation if you install a new VST3.

## Installing

Run `./installer.sh` and follow instructions printed out on the installer.
